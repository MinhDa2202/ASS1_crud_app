    ...
    <div className="bg-white/5 backdrop-blur-lg border border-white/20 rounded-2xl p-6 shadow-2xl">
      ...
      {isLoading ? (
        <div className="text-center py-12">
          <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-white/10 flex items-center justify-center animate-spin">
            <svg
          ...
          <p className="text-gray-300 text-lg">Đang tải sản phẩm...</p>
        </div>
      ) : products.length === 0 ? (
        <div className="text-center py-12">
